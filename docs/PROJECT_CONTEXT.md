...
- A forced receiver interruption left no committed or partial capture, and the app/node recovered without a Pi reboot. Literal cable unplug/replug, live UI error presentation during interruption, electrical power measurement, and concurrent four-node behavior remain unverified.
